...
| [`curriculum-and-context-pipeline.md`](./curriculum-and-context-pipeline.md) | Two-phase pipeline: PDF → Lehrplan topic extraction at upload time, and `assembleContext()` composing topic window + diary entries + transition summary per request. |
